...
/* harmony export */ });
/* harmony import */ var _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90261);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(41506);
...
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16750);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(77046);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(80071);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(697);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(83765);
/* harmony import */ var dagre_d3_es__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(43709);
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(68313);
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(90445);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(97375);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_14__);
...
const tasks = [];
const rawTasks = [];
const getCommonDb = () => _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.j;
const parseDirective = (statement, context, type) => {
  (0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.k)(globalThis, statement, context, type);
};
const clear = function() {
  ...
  currentSection = "";
  rawTasks.length = 0;
  (0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.m)();
};
...
const draw = function(text, id, version, diagObj) {
  const conf2 = (0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.g)();
  const LEFT_MARGIN = conf2.leftMargin ? conf2.leftMargin : 50;
  diagObj.db.clear();
  diagObj.parser.parse(text + "\n");
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("timeline", diagObj.db);
  ...
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("task", tasks2);
  svgDraw.initGraphics(svg);
  const sections2 = diagObj.db.getSections();
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("sections", sections2);
  ...
  sections2.forEach(function(section) {
    ...
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("sectionHeight before draw", sectionHeight);
    maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
  });
  let maxEventCount = 0;
  let maxEventLineLength = 0;
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("tasks.length", tasks2.length);
  for (const [i, task] of tasks2.entries()) {
    ...
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("taskHeight before draw", taskHeight);
  ...
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("maxSectionHeight before draw", maxSectionHeight);
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("maxTaskHeight before draw", maxTaskHeight);
  if (sections2 && sections2.length > 0) {
    sections2.forEach((section) => {
      ...
      _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("sectionNode", sectionNode);
      const sectionNodeWrapper = svg.append("g");
      const node = svgDraw.drawNode(sectionNodeWrapper, sectionNode, sectionNumber, conf2);
      _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("sectionNode output", node);
  ...
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("bounds", box);
  if (title) {
  ...
  (0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.s)(
    void 0,
    svg,
...
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf2, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
  for (const task of tasks2) {
    ...
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("taskNode", taskNode);
    const taskWrapper = diagram2.append("g").attr("class", "taskWrapper");
    const node = svgDraw.drawNode(taskWrapper, taskNode, sectionColor, conf2);
    const taskHeight = node.height;
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("taskHeight after draw", taskHeight);
    ...
    masterX = masterX + 200;
    if (isWithoutSections && !(0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.g)().timeline.disableMulticolor) {
      sectionColor++;
    }
  }
  masterY = masterY - 10;
...
const drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf2) {
  ...
  for (const event of events) {
    ...
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("eventNode", eventNode);
