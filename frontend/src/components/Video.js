...
// containerless: when true, render only the video frame (no card/header)
const VideoPlayer = ({ labID, containerless = false }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-6 dark:bg-cp-panel dark:border-cp-border dark:shadow-cp">
      <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 dark:bg-cp-panel-alt dark:border-cp-border">
