...
// Mock child components (use correct file names / casing)
jest.mock('../Video', () => () => <div data-testid="video-player">Video Player</div>);
jest.mock('../IDE', () => () => <div data-testid="ide">IDE Component</div>);
jest.mock('../LabText', () => () => <div data-testid="lesson-text">Lesson Text</div>);
