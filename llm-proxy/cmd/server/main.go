...
import (
	...
	"github.com/labbrly/llmproxy/internal/llmproxy"
...
func main() {
	...
	ragCol := mongoClient.Database("rag").Collection("documents")

	store := llmproxy.New(orgsCol, labsCol, ragCol)
	...
	go func() {
		slog.Info("llm-proxy service starting", "addr", srv.Addr)
